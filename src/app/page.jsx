...
const albumCovers = [
  {
    name: "Aashiqui 2",
    url: "https://yt3.googleusercontent.com/3q33amH9hzn1dO8IeAX7TMb1QtEVfvVbqd2eSCaelOXNVmfMjbpDYdqD2HSiXtNP6i5Es7oynkWU2NfOXA=w544-h544-l90-rj",
  },
  {
    name: "Brahmastra",
    url: "https://yt3.googleusercontent.com/eLoQKzskAIeNPego41FH2sz5uFy-A3Ynf1rcNdQ4eKv4J10atKk_RKbZDnQ3Ja-UNM8mKSu_-8gNeVYp4g=w544-h544-l90-rj",
  },
  {
    name: "Kabir Singh",
    url: "https://yt3.googleusercontent.com/loAKTa9XpvZzV-TORspRPC978Kk_u2l6tYlHTHm-sYfwjmKsJdShoxbmLoPKoq9eZgq-uzpoRPtqEWX09w=w544-h544-l90-rj",
  },
  {
    name: "Rockstar",
    url: "https://yt3.googleusercontent.com/KYw74XSQwtKPbZTrHMNEBAnEMg1P1gNGwymnZwBSjstbqSE-MpigGlTIy6IZvC-ERlRkeP0c7VTiZObS=w544-h544-l90-rj",
  },
  {
    name: "Dilwale",
    url: "https://yt3.googleusercontent.com/7FxbxKIussM0Pu0YJa9eXy2eN9-f8g82NFoKpeepDQavqn_Auja9TzR_9b1wgMrfHQrGDLOtQymO-PfZ=w544-h544-l90-rj",
  },
  {
    name: "Animal",
    url: "https://yt3.googleusercontent.com/tM7On61s7pbU8DsHeusopX-HRQerc4Xyv2Pc5Nveb3F932QuadCwslZEP_yeU7iQk2XX9w-r63nZgZk=w544-h544-l90-rj",
  },
];
...
export default function LandingPage() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative bg-[#050505] text-white overflow-x-hidden select-none"
    >
...
// ----------------------------------------------------
function HeroSection({ scrollYProgress, router }) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const sortedParticles = particles.map((p) => {
        ...
        let x1 =
          p.x * Math.cos(rotationY + autoAngle) -
          p.z * Math.sin(rotationY + autoAngle);
        let z1 =
          p.x * Math.sin(rotationY + autoAngle) +
          p.z * Math.cos(rotationY + autoAngle);
      ...
      sortedParticles.forEach((p) => {
        ...
        if (px >= 0 && px <= width && py >= 0 && py <= height) {
          const alpha = Math.max(
            0.1,
            Math.min(1.0, (fov - p.rz) / (fov * 0.8)),
          );
          ctx.beginPath();
          ctx.arc(
            px,
            py,
            p.size * scale * 1.5 * Math.max(0.7, designScale),
            0,
            Math.PI * 2,
          );
          ...
          if (p.rz < -50 && Math.random() > 0.985) {
            ...
            ctx.arc(
              px,
              py,
              p.size * scale * 4 * Math.max(0.7, designScale),
              0,
              Math.PI * 2,
            );
      ...
      orbits.forEach((orb) => {
        ...
        if (finalZ > 0) {
          ...
          ctx.arc(
            px,
            py,
            6 * scale * Math.max(0.7, designScale),
            0,
            Math.PI * 2,
          );
  ...
  return (
    ...
    >
      ...
      <div className="h-screen w-full flex flex-col justify-center items-center relative z-20 text-center px-4">
        ...
        >
          Discover, Stream and Feel Every Beat. A futuristic universe of sound
          with zero latency, syncing across all your screens.
        </motion.p>
      ...
      <div
        id="features"
        className="w-full max-w-5xl mx-auto px-6 py-20 relative z-20 min-h-screen flex flex-col justify-center items-center"
      >
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-500 text-sm max-w-md mx-auto">
            Experience audio playback designed for high-fidelity devices,
            rendering crystal-clear vocals.
          </p>
        </div>
  ...
  return (
    <section className="relative w-full max-w-6xl mx-auto px-6 min-h-screen z-20 flex flex-col lg:flex-row items-center justify-center gap-16 py-20">
      ...
      <div className="flex-1 space-y-6 text-center lg:text-left">
        ...
        >
          Switch between fully interactive views dynamically. Search songs
          instantly, review live synchronized lyrics, control tracks with custom
          album visualizers, and view personalized shelves designed for the
          ultimate audiophile.
        </motion.p>
      ...
      <div className="flex-1 flex items-center justify-center relative w-full max-w-[340px] aspect-[9/19] h-[580px]">
        ...
        >
          ...
          <div
            className="absolute inset-0 w-[200%] h-full bg-gradient-to-r from-transparent via-white/5 to-transparent z-30 pointer-events-none rounded-[36px] -translate-x-full group-hover:animate-glare-sweep"
...
function WhySoniqueSection() {
  return (
    <section
      id="why-sonique"
      className="relative w-full max-w-5xl mx-auto px-6 min-h-screen z-20 flex flex-col justify-center py-20"
    >
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-zinc-500 text-sm max-w-md mx-auto">
          We combine minimalist elegance with robust engineering to provide an
          audio environment built for modern music listeners.
        </p>
      </div>
...
function TiltGlassPanel({ title, desc, badge, glow, floatOffset }) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4" style={{ transform: "translateZ(30px)" }}>
        ...
        <p className="text-zinc-400 text-sm leading-relaxed max-w-md">{desc}</p>
      </div>

      <div
        className="mt-8 border-t border-white/5 pt-4 flex items-center justify-between"
        style={{ transform: "translateZ(15px)" }}
      >
        <span className="text-xs font-semibold text-zinc-500 group-hover:text-white transition duration-300">
          Learn more
        </span>
...
// ----------------------------------------------------
function MusicGalaxySection({ scrollYProgress }) {
  const canvasRef = useRef(null);
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      particles.forEach((p) => {
        ...
        if (px >= 0 && px <= width && py >= 0 && py <= height) {
          ...
          ctx.arc(
            px,
            py,
            p.size * scale * Math.max(0.8, designScale),
            0,
            Math.PI * 2,
          );
      ...
      planetaryCovers.forEach((album) => {
        ...
        const finalX = ax;
        const finalY =
          album.yOffset * designScale * Math.cos(pitch) - az * Math.sin(pitch);
        const finalZ =
          album.yOffset * designScale * Math.sin(pitch) + az * Math.cos(pitch);
  ...
  return (
    ...
    >
      <div className="text-center mb-20 space-y-4">
        ...
        <p className="text-zinc-500 text-sm max-w-md mx-auto">
          Take a sneak peek inside the high-performance Sonique interface
          controls.
        </p>
      </div>
      ...
      <div className="relative h-[650px] w-full flex items-center justify-center">
        ...
        >
          <div className="flex items-center gap-1.5 border-b border-white/5 pb-2">
            ...
            <span className="font-extrabold text-[9px] text-zinc-300">
              Discover Mix
            </span>
          </div>
        ...
        >
          <div className="flex items-center justify-between border-b border-white/5 pb-2">
            ...
            <span className="text-[7px] text-purple-400 font-bold uppercase">
              5 Songs Remaining
            </span>
          </div>
          <div className="flex flex-col gap-1.5 flex-1 justify-center">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-1.5 rounded bg-zinc-950/60 border border-white/5 text-[8px]"
              >
                <div className="flex items-center gap-2">
                  <div
                    className="w-5 h-5 rounded bg-cover"
                    style={{
                      backgroundImage: `url(${albumCovers[i % albumCovers.length].url})`,
                    }}
                  />
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-zinc-300 font-extrabold tracking-wider uppercase">
                Sonique Live Stream
              </span>
            </div>
          ...
          <div className="flex items-center gap-4 py-4">
            <div
              className="w-16 h-16 rounded-xl bg-cover border border-white/10 shadow-lg animate-spin-slow"
              style={{ backgroundImage: `url(${albumCovers[1].url})` }}
            />
            <div className="flex-1 space-y-1">
              ...
              <p className="text-xs text-zinc-400">
                Pritam • Arijit Singh • Sid Sriram
              </p>
              <div className="flex items-center gap-2">
                <span className="text-[9px] bg-purple-500/20 text-purple-300 px-1.5 py-0.5 rounded border border-purple-500/10">
                  320kbps AAC
                </span>
                <span className="text-[9px] bg-white/5 text-zinc-400 px-1.5 py-0.5 rounded animate-pulse">
                  Stereo
                </span>
              </div>
            </div>
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="w-8 h-8 rounded-full bg-white text-zinc-950 flex items-center justify-center font-extrabold hover:scale-105 active:scale-95 transition shadow-lg shadow-white/10">
                  ⏸
                </button>
                <button className="text-zinc-400 hover:text-white transition">
                  ⏭
...
function CTASection({ router }) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      portalGlow.addColorStop(
        0,
        hovered ? "rgba(168, 85, 247, 0.28)" : "rgba(168, 85, 247, 0.18)",
      );
      portalGlow.addColorStop(
        0.6,
        hovered ? "rgba(236, 72, 153, 0.14)" : "rgba(236, 72, 153, 0.08)",
      );
      ...
      particles.forEach((p) => {
        ...
        const alpha = Math.max(
          0.1,
          Math.min(0.8, (p.distance * designScale) / 200),
        );
        ...
        ctx.arc(
          px,
          py,
          p.size * (hovered ? 1.5 : 1.0) * Math.max(0.7, designScale),
          0,
          Math.PI * 2,
        );
        ctx.fillStyle = `${p.color}${alpha})`;
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center z-20 text-center px-4 overflow-hidden border-t border-white/5 py-20">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none z-10 flex items-center justify-center">
        <canvas
          ref={canvasRef}
          className="w-full h-full max-w-[800px] max-h-[800px] opacity-90"
        />
      </div>
      ...
      <div className="relative z-20 max-w-2xl space-y-6">
        ...
        >
          Join the next generation of music discovery. Stream high-definition
          tracks, enjoy synchronized lyrics, and structure customized playlists
          in seconds.
        </motion.p>
      ...
      <div className="w-full h-full bg-[#09090b] p-4 text-left font-sans text-[10px] select-none flex flex-col gap-3">
        <div className="flex items-center justify-between border-b border-white/5 pb-2">
          <div className="flex items-center gap-1.5">
            <div className="w-4 h-4 rounded bg-purple-500 flex items-center justify-center text-[8px] font-black shadow-[0_0_5px_rgba(168,85,247,0.5)] animate-pulse">
              S
            </div>
            <span className="font-extrabold text-[9px] text-white">
              Sonique
            </span>
          </div>
        ...
        <div className="rounded-lg bg-gradient-to-r from-purple-600/30 to-pink-500/20 border border-white/5 p-3 flex flex-col gap-1 relative overflow-hidden">
          <span className="text-[7px] text-zinc-400 tracking-wider uppercase font-semibold">
            AI recommendation engine active
          </span>
          <span className="text-xs font-bold text-white">Good Evening</span>
          <span className="text-[8px] text-zinc-400">
            Discover handpicked recommendation shelves.
          </span>
        </div>
        <div className="flex flex-col gap-1.5">
          <span className="font-bold text-[9px] text-zinc-300">
          ...
          <div className="flex gap-2 overflow-x-hidden">
            <div className="w-14 shrink-0 flex flex-col gap-1 bg-zinc-900/50 p-1.5 rounded-lg border border-white/5 hover:border-purple-500/20 transition">
              <div
                className="aspect-square bg-zinc-800 rounded-md overflow-hidden bg-cover"
                style={{ backgroundImage: `url(${albumCovers[0].url})` }}
              />
              <span className="text-[7px] font-bold text-white truncate">
                {albumCovers[0].name}
              </span>
            </div>
            <div className="w-14 shrink-0 flex flex-col gap-1 bg-zinc-900/50 p-1.5 rounded-lg border border-white/5 hover:border-purple-500/20 transition">
            ...
            <div className="w-14 shrink-0 flex flex-col gap-1 bg-zinc-900/50 p-1.5 rounded-lg border border-white/5 hover:border-purple-500/20 transition">
              <div
                className="aspect-square bg-zinc-800 rounded-md overflow-hidden bg-cover"
                style={{ backgroundImage: `url(${albumCovers[2].url})` }}
              />
              <span className="text-[7px] font-bold text-white truncate">
                {albumCovers[2].name}
              </span>
    ...
    layout: (
      <div className="w-full h-full bg-[#09090b] p-4 text-left font-sans text-[10px] select-none flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-1">
          <span className="px-2 py-0.5 rounded-full bg-purple-500/20 border border-purple-500/20 text-[6px] text-purple-300 font-bold">
            Audios
          </span>
          <span className="px-2 py-0.5 rounded-full bg-white/5 border border-white/5 text-[6px] text-zinc-400">
            Videos
          </span>
          <span className="px-2 py-0.5 rounded-full bg-white/5 border border-white/5 text-[6px] text-zinc-400">
            Playlists
        ...
        <div className="flex flex-col gap-1.5 mt-2">
          ...
          <div className="flex flex-col gap-1">
            {[
              ...
              <div
                key={idx}
                className="flex items-center justify-between p-1.5 rounded-lg bg-zinc-900/40 border border-white/5"
              >
                <div className="flex items-center gap-1.5">
                  <div
                    className="w-6 h-6 rounded bg-cover"
                    style={{
                      backgroundImage: `url(${albumCovers[idx % albumCovers.length].url})`,
                    }}
                  />
                  <div className="flex flex-col">
                    <span className="font-bold text-[8px] text-white">
    ...
    layout: (
      <div className="w-full h-full bg-gradient-to-b from-[#180828] to-[#09090b] p-4 text-left font-sans text-[10px] select-none flex flex-col gap-4">
        ...
        <div className="flex-1 flex flex-col gap-3 py-2 justify-center font-bold text-[11px] leading-relaxed text-zinc-500/80">
          ...
          <p className="text-white drop-shadow-[0_0_12px_rgba(168,85,247,0.7)] scale-105 origin-left transition duration-300">
      ...
      <div className="w-full h-full bg-[#050505] p-4 text-center font-sans text-[10px] select-none flex flex-col justify-between">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-center gap-4 py-1">
            <div className="w-5 h-5 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-zinc-400">
              ⏮
            </div>
