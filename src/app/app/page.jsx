...
import { getHomeShelves, fetchTrendingVideos } from "../../lib/recommendations";
...
const musicAlbums = [
  {
    ...
    name: "Aashiqui 2",
    cover:
      "https://yt3.googleusercontent.com/3q33amH9hzn1dO8IeAX7TMb1QtEVfvVbqd2eSCaelOXNVmfMjbpDYdqD2HSiXtNP6i5Es7oynkWU2NfOXA=w544-h544-l90-rj",
  },
  {
    id: "MPREb_iM8jILFK2Qm",
    name: "Brahmastra",
    cover:
      "https://yt3.googleusercontent.com/eLoQKzskAIeNPego41FH2sz5uFy-A3Ynf1rcNdQ4eKv4J10atKk_RKbZDnQ3Ja-UNM8mKSu_-8gNeVYp4g=w544-h544-l90-rj",
  },
  {
    id: "MPREb_RcOqUyfS2Bi",
    name: "Kabir Singh",
    cover:
      "https://yt3.googleusercontent.com/loAKTa9XpvZzV-TORspRPC978Kk_u2l6tYlHTHm-sYfwjmKsJdShoxbmLoPKoq9eZgq-uzpoRPtqEWX09w=w544-h544-l90-rj",
  },
  {
    id: "MPREb_QFpeH3GzBe4",
    name: "Yeh Jawaani Hai Deewani",
    cover:
      "https://yt3.googleusercontent.com/8WRsPwoMoabdu5ISlf9f7tGGPzd2I7CTaWxc8qd6GYjaEBreC2Yw0KWMId6Y2vUTqSkt7GdlUi4NAXyf=w544-h544-l90-rj",
  },
  {
    id: "MPREb_apAhqhJObbd",
    name: "Bhediya",
    cover:
      "https://yt3.googleusercontent.com/5yKTPfOWf1AhqP0QY29N1uOL3lYq4hq9ZCJoWgugoB_WSf_MVHkr-C5FRuWJsakWjlaPzhiy1_fZHjxx=w544-h544-l90-rj",
  },
  {
    id: "MPREb_FNWEz3Y5YyZ",
    name: "Munjya",
    cover:
      "https://yt3.googleusercontent.com/7BiezafiDJcnp1s7UffTwd_VM9xVTZFzmb_yoiM4O2HEXecTA2OkW2CySTmqsyxeQsd36fv5P2FmBls=w544-h544-l90-rj",
  },
  {
    id: "MPREb_E9Diy6kXmlV",
    name: "Rockstar",
    cover:
      "https://yt3.googleusercontent.com/KYw74XSQwtKPbZTrHMNEBAnEMg1P1gNGwymnZwBSjstbqSE-MpigGlTIy6IZvC-ERlRkeP0c7VTiZObS=w544-h544-l90-rj",
  },
  {
    id: "MPREb_Wv34uDr4ODd",
    name: "Dilwale",
    cover:
      "https://yt3.googleusercontent.com/7FxbxKIussM0Pu0YJa9eXy2eN9-f8g82NFoKpeepDQavqn_Auja9TzR_9b1wgMrfHQrGDLOtQymO-PfZ=w544-h544-l90-rj",
  },
  {
    id: "MPREb_suGXcALkg8R",
    name: "Ae Dil Hai Mushkil",
    cover:
      "https://yt3.googleusercontent.com/0eoKSZD2aThVTG85MaO4j6r_pVMmDlvnlMWmhGEn9WBak9Ncu9uFRYh82uKZqqouebyaBcI4WLhvQrml=w544-h544-l90-rj",
  },
  {
    id: "MPREb_iE3Pd08juWf",
    name: "Shershaah",
    cover:
      "https://yt3.googleusercontent.com/iL_YgaRWLLzfwYP1mL9mTl0776jHYymJnsNcQlkzztzVEks8z__hMIKIvMfggcaqLah3pdQxR1NcWnPf=w544-h544-l90-rj",
  },
  {
    id: "MPREb_PrESMGET7eK",
    name: "Animal",
    cover:
      "https://yt3.googleusercontent.com/tM7On61s7pbU8DsHeusopX-HRQerc4Xyv2Pc5Nveb3F932QuadCwslZEP_yeU7iQk2XX9w-r63nZgZk=w544-h544-l90-rj",
  },
  {
    id: "MPREb_kOsn8M38LcA",
    name: "Laila Majnu",
    cover:
      "https://yt3.googleusercontent.com/0is50INmTrcfZEK3onQ67l6lxLM6ECEhjuPbepEsqnqOsRse3G6ortxZxBGtSI---0GI0nVIF4CoObYaSw=w544-h544-l90-rj",
  },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("sonique_history_changed", loadLocalHistory);
  }, []);
  ...
  const rawShelves = shelves
    ? [
        ...
        },
        {
          ...
          tracks:
            shelves.continue_listening && shelves.continue_listening.length > 0
        ...
        },
        {
          ...
          tracks:
            shelves.recently_played && shelves.recently_played.length > 0
        ...
        },
        {
          ...
          title: profile
            ? "Discover New Music"
            : "Discover New Music with Fresh Songs",
  ...
  const convertToPlayerTrack = (track) => ({
    ...
    sourceUrl:
      track.sourceUrl || `${API_BASE}/stream/${track.id}?redirect=true`,
          ...
          <div key={index} className="space-y-4">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="w-48 md:w-52 aspect-square bg-zinc-900/40 rounded-xl border border-white/5 shrink-0"
                />
              ))}
            </div>
          </div>
  ...
  return (
    <div className="space-y-6 md:space-y-10 pb-8 select-none">
          ...
          {profile ? (
            <>
              ...
              <p className="text-zinc-400 text-sm md:text-base max-w-lg">
                Your personalized feed is learning and updating in real-time
                based on your listens, skips, and playlist preferences.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-zinc-400 text-sm md:text-base max-w-lg">
                Explore handpicked tracks, popular albums, and trending mixes.{" "}
                <Link
                  href="/login"
      ...
      {shelvesList
        .slice(0, profile ? visibleShelvesCount : shelvesList.length)
        .map((shelf) => {
          const hasTracks =
            "tracks" in shelf && shelf.tracks && shelf.tracks.length > 0;
          const hasArtists =
            "artists" in shelf && shelf.artists && shelf.artists.length > 0;
          const hasAlbums =
            "albums" in shelf && shelf.albums && shelf.albums.length > 0;
          const hasVideos =
            "videos" in shelf && shelf.videos && shelf.videos.length > 0;
          if (!hasTracks && !hasArtists && !hasAlbums && !hasVideos)
            return null;
                  ...
                  {shelf.albums.map((album) => (
                    ...
                    >
                      ...
                      <div className="text-left overflow-hidden w-full">
                        <h4 className="text-xs md:text-sm font-bold text-white truncate group-hover:text-violet-400 transition">
                          {album.name}
                        </h4>
                      </div>
                    </div>
