...
export function SleepTimerModal() {
  const { showSleepTimerModal, setShowSleepTimerModal, accentColor } =
    useUIStore();
  ...
  const handleSelectOption = (minutes) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-zinc-900 border border-white/10 p-6 rounded-xl w-full max-w-sm shadow-2xl relative text-white animate-fade-in">
        ...
        <p className="text-sm text-zinc-400 mb-6 leading-relaxed">
          Set a timer to automatically pause playback after the duration
          expires. Perfect for falling asleep.
        </p>
