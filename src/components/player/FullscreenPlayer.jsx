    ...
    <AnimatePresence>
      ...
      >
        ...
        <header className="h-16 sticky top-0 flex items-center justify-between px-6 z-20 border-b border-white/5 bg-zinc-950 transform-gpu pointer-events-auto">
          ...
          <div className="flex items-center gap-6 font-semibold text-sm">
            <button
              ...
              style={{
                borderBottomColor:
                  activeTab === "player" ? accentColor : "transparent",
              }}
            >
              Player
            </button>
            <button
              ...
              style={{
                borderBottomColor:
                  activeTab === "lyrics" ? accentColor : "transparent",
              }}
            >
              Lyrics
            </button>
            <button
              ...
              style={{
                borderBottomColor:
                  activeTab === "queue" ? accentColor : "transparent",
              }}
            >
              Up Next
            </button>
        ...
        <main className="flex-1 min-h-0 flex flex-col md:flex-row p-4 sm:p-6 md:p-12 overflow-hidden gap-4 md:gap-16 z-10 max-w-7xl mx-auto w-full items-center pointer-events-auto">
          ...
          <div
            className={`h-full max-h-full flex flex-col justify-between items-center max-w-md mx-auto w-full pt-2 pb-6 md:py-2 transition-all duration-300 ${activeTab !== "player" ? "hidden md:flex" : "flex"}`}
          >
                ...
                <img
                  src={
                    ...
                    currentTrack.coverUrl !== "undefined"
                      ? currentTrack.coverUrl
                      : currentTrack.id && currentTrack.id.length === 11
            ...
            <div className="w-full flex items-center justify-between gap-4 shrink-0 px-2">
              <div className="overflow-hidden flex-1 text-left">
                <h2 className="text-xl md:text-2xl font-bold truncate tracking-tight">
                  {currentTrack.title}
                </h2>
                <p className="text-sm md:text-md text-zinc-400 truncate mt-1">
                  {currentTrack.artist}
                </p>
              </div>
            ...
            <div className="w-full flex items-center justify-between px-2 shrink-0">
              ...
              <button
                ...
                style={{
                  color: repeatMode !== "none" ? accentColor : undefined,
                }}
              >
          ...
          <div
            className={`flex-1 min-w-0 h-full overflow-hidden flex flex-col justify-center transition-all duration-300 pt-4 ${activeTab === "player" ? "hidden md:flex" : "flex"}`}
          >
            {activeTab === "queue" ? (
              <div className="h-full overflow-y-auto overscroll-contain pr-2 queue-scrollbar py-4 flex flex-col gap-2">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="overflow-hidden flex-1">
                        <p
                          className={`text-sm font-semibold truncate ${isCurrent ? "text-white" : "text-zinc-300"}`}
                ...
                {activeQueue.length === 0 && (
                  <p className="text-zinc-500 text-center italic mt-12 text-sm">
                    Queue is empty
                  </p>
                )}
              </div>
